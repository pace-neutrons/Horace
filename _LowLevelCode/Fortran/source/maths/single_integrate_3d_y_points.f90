...
!-----------------------------------------------------------------------------------------------------------------------------------
! Integrate y-axis over a 3D data set with point character along the y-axis between two limits.
...
!-----------------------------------------------------------------------------------------------------------------------------------
	...
	real(dp) y1eff, yneff
	real(dp), dimension(size(s,1),size(s,3)) :: s1eff, sneff, e1eff, eneff
