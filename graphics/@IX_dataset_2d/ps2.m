...
% Overplot a surface plot of an IX_dataset_2d or array of IX_dataset_2d, with error bars as colour
%
%   >> ps2(w)
%
% Advanced use:
%   >> ps2(w,...,'name',fig_name)        % draw with name = fig_name
%
% Differs from ps in that the signal sets the z axis, and the colouring is 
