...
# Highlights
 ...
 - #1925 Horace images now contain references to the Horace objects, plotted on them.
   `src(figure)` command allows one to retrieve the object from the figure and perform
   following operations over this object.
