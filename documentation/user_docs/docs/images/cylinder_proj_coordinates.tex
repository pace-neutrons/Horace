...
\begin{tikzpicture}[x={(-5mm,-3.85mm)},z={(0,1cm)},y={(1cm,-.3cm)}]
  ...
  \draw [->] (0,0) -- (0,5,0) node [above,xshift=-0.8cm,yshift=0.5cm] {$e_y = e_x \times e_z$};
  \draw [->] (0,0) -- (0,0,5) node [right,yshift=-0.5cm] {$u$,$e_z$};

  \draw [->,text=green] (0,0) -- (6,0,0) node [right,xshift=0.5cm,yshift=0.2cm] {$e_x$ = $e_z \times e_y$};
  ...
  \draw [line width=2pt,->] (0,0,0) -- (3,3,0) node [above,xshift=-0.1cm,yshift=1cm] {$Q_{tr}$};
