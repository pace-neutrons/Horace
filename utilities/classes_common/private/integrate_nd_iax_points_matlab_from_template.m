function integrate_nd_iax_points_matlab_from_template
% Create integration functions for point data from template
%
%   >> integrate_nd_iax_points_matlab_from_template
%
% Run from the folder that containsa this untility function

substr_in={'integrate_nd_iax_points_matlab_template','iax=1','ndim=2','(ib,:)','(ilo,:)','(ihi,:)',...
...
template_file='integrate_nd_iax_points_matlab_template.m';
