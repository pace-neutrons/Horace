...
%   >> wout = rebin_y (win, [])
%   >> wout = rebin_y (win, 10)
%   >> wout = rebin_y (win, [2000,3000])
%   >> wout = rebin_y (win, [2000,Inf])
%   >> wout = rebin_y (win, [2000,10,3000])
%   >> wout = rebin_y (win, [5,-0.01,3000])
%   >> wout = rebin_y (win, [5,-0.01,1000,20,4000,50,20000])
%
...
wout = rebin(win,true,2,varargin{:});
