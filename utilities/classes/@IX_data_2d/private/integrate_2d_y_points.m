function [sout,eout] = integrate_2d_y_points (x, s, e, xout, use_mex, force_mex)
% Integrates point data along axis iax=2 of an IX_dataset_nd with dimensionality ndim=2.
%
%   >> [sout,eout] = integrate_2d_y_points (x, s, e, xout, use_mex, force_mex)
%
% Input:
% ------
...
if use_mex
    try
        [sout,eout] = integrate_2d_y_points_mex (x, s, e, xout);
    catch
        if ~force_mex
