function [sout,eout] = integrate_1d_points (x, s, e, xout, use_mex, force_mex)
% Integrates point data along axis iax=1 of an IX_dataset_nd with dimensionality ndim=1.
%
%   >> [sout,eout] = integrate_1d_points (x, s, e, xout, use_mex, force_mex)
%
% Input:
% ------
...
if use_mex
    try
        [sout,eout] = integrate_1d_points_mex (x, s, e, xout);
    catch ERR
        if ~force_mex
