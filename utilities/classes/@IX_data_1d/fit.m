...
%   <a href="matlab:help('IX_dataset_1d/multifit');">click here</a>.
%
%   Help for the legacy operation can be <a href="matlab:help('IX_dataset_1d/fit_legacy');">found here</a>]
...
% -----------------------------------------------------------------------------
% <#doc_beg:> multifit
%   <#file:>  <doc_deprecated_fit>  IX_dataset_1d/  ''
% <#doc_end:>
%-------------------------------------------------------------------------------
