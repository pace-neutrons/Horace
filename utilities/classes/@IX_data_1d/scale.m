function wout = scale(w,xscale)
% Rescale the x-axis for an IX_dataset_1d object or array of IX_dataset_1d objects
%
%   >> wout = scale(w,xscale)
%
% Input:
...
elseif numel(w)~=numel(xscale)
    error('Check number of elements in IX_dataset_1d and scale arrays')
end
