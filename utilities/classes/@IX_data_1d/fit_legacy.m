...
% Fits a function to an IX_dataset_1d object, with an optional background function.
%
...
% Input:
% ======
%   w       IX_dataset_1d object or array of IX_dataset_1d objects to be fitted
%
...
% Output:
% =======
%   wout    IX_dataset_1d object or array of IX_dataset_1d objects evaluated at the
...
%   >> [yfit,fitpar]=fit_legacy(w,@gauss,pin,@linear_bg,bg)
%
% Remove a portion of the data, and give copious output during the fitting
%
%   >> [yfit,fitpar]=fit_legacy(w,@gauss,pin,@linear_bg,bg,'remove',[12,14],'list',2)
%
% Fix the position and constrain the width to be a constant multiple of
% the constant part of the linear background:
%
%   >> [yfit,fitpar]=fit_legacy(w,@gauss,pin,[1,0,1],{3,1,1},@linear_bg,bg)

%-------------------------------------------------------------------------------
% <#doc_def:>
%   multifit_doc = fullfile(fileparts(which('multifit_gateway_main')),'_docify');
%   first_line = {'% Fits a function to an IX_dataset_1d object, with an optional background function.'}
%   main = false;
%   method = true;
%   synonymous = false;
%
...
%   obj_name = 'IX_dataset_1d'
%
%   doc_forefunc = fullfile(multifit_doc,'doc_func_simple_1d.m')
%   doc_backfunc = fullfile(multifit_doc,'doc_func_simple_1d.m')
%
