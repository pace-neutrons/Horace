...
% Simultaneously fits a function to an array of IX_dataset_3d objects, with
...
% Input:
% ======
%   w       IX_dataset_3d object or array of IX_dataset_3d objects to be fitted
%
...
% Output:
% =======
%   wout    IX_dataset_3d object or array of IX_dataset_3d objects evaluated at the
...
% of multifit, although the dimensionality of the examples is different.
% Type  >> help IX_dataset_1d/multifit  or  >> help IX_dataset_2d/multifit
% and look at the examples.

% <#doc_def:>
%   first_line = {'% Simultaneously fits a function to an array of IX_dataset_3d objects, with',...
%                 '% optional background functions.'}
%   main = false;
%   method = true;
%   synonymous = false;
...
%
%   doc_forefunc = 'multifit_doc:::doc_func_simple_3d.m'
%   doc_backfunc = 'multifit_doc:::doc_func_simple_3d.m'
%
