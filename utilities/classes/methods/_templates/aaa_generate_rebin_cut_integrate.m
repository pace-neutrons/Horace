...
output_file{2}={fullfile(dir_3d,'rebin2.m'),...
                fullfile(dir_1d,'rebin2.m'),...
...
substr_out{1}={[{'rebin',  'rebin2',  'IX_dataset_1d','x-axis','descr','',''},{'1'},rebin_descr_opt],...
               ...
               [{'rebin_y','rebin2_y','IX_dataset_2d','y-axis','descr','',''},{'1'},rebin_descr_opt],...
               ...
               [{'rebin_y','rebin2_y','IX_dataset_3d','y-axis','descr','',''},{'1'},rebin_descr_opt],...
               [{'rebin_z','rebin2_z','IX_dataset_3d','z-axis','descr','',''},{'1'},rebin_descr_opt],...
              };
substr_out{2}={[{'rebin2',  'rebin',  'IX_dataset_1d','x-axis','descr','',''},{'1'},rebin2_descr_opt],...
               ...
               [{'rebin2_y','rebin_y','IX_dataset_2d','y-axis','descr','',''},{'1'},rebin2_descr_opt],...
               ...
               [{'rebin2_y','rebin_y','IX_dataset_3d','y-axis','descr','',''},{'1'},rebin2_descr_opt],...
               [{'rebin2_z','rebin_z','IX_dataset_3d','z-axis','descr','',''},{'1'},rebin2_descr_opt],...
              };
substr_out{3}={[{'integrate',  'integrate2',  'IX_dataset_1d','x-axis','descr','',''},{'1'},integrate_descr_opt],...
               ...
               [{'integrate_y','integrate2_y','IX_dataset_2d','y-axis','descr','',''},{'1'},integrate_descr_opt],...
               ...
               [{'integrate_y','integrate2_y','IX_dataset_3d','y-axis','descr','',''},{'1'},integrate_descr_opt],...
               [{'integrate_z','integrate2_z','IX_dataset_3d','z-axis','descr','',''},{'1'},integrate_descr_opt],...
              };
substr_out{4}={[{'integrate2',  'integrate',  'IX_dataset_1d','x-axis','descr','',''},{'1'},integrate2_descr_opt],...
               ...
               [{'integrate2_y','integrate_y','IX_dataset_2d','y-axis','descr','',''},{'1'},integrate2_descr_opt],...
               ...
               [{'integrate2_y','integrate_y','IX_dataset_3d','y-axis','descr','',''},{'1'},integrate2_descr_opt],...
               [{'integrate2_z','integrate_z','IX_dataset_3d','z-axis','descr','',''},{'1'},integrate2_descr_opt],...
              };
substr_out{5}={[{'cut',  'cut2',  'IX_dataset_1d','x-axis','descr','',''},{'1'},cut_descr_opt],...
               ...
               [{'cut_y','cut2_y','IX_dataset_2d','y-axis','descr','',''},{'1'},cut_descr_opt],...
               ...
               [{'cut_y','cut2_y','IX_dataset_3d','y-axis','descr','',''},{'1'},cut_descr_opt],...
               [{'cut_z','cut2_z','IX_dataset_3d','z-axis','descr','',''},{'1'},cut_descr_opt],...
              };
