function wout = simple_rebind(win, xdescr, ydescr, opt)
% Rebin IX_dataset_2d along x and y axes using reference 1D algorithm
%
%   >> wout = simple_rebind(win, xdescr, ydescr)
%   >> wout = simple_rebind(win, xdescr, ydescr, 'int')    % trapezoidal integration of point data
%
