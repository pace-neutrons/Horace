...
elseif strcmp(type,'struct')
    ...
    % 19 Sep 2014, TGP: change 'ubit1=>logical' to 'ubit8=>logical'
    class_type={'char','double','single','logical','int8','int16','int32','int64','uint8','uint16','uint32','uint64'};
    fmt={'*char*1','float64=>double','float32=>single','ubit8=>logical','int8','int16','int32','int64','uint8','uint16','uint32','uint64'};
