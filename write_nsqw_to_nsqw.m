function [grid_size, urange] = write_nsqw_to_nsqw (infiles, outfiles, grid_size_in, urange_in)
...
for i=1:nfiles
    [main_header{i},header{i},det_tmp,datahdr{i},mess,position,npixtot,type] = sqw_get (infiles{i},'-h');
...
for i=1:nfiles
    ...
    mess=sqw_put (outfiles{i},main_header{i},header{i},det,sqw_data);
