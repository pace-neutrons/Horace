% Create some samples
s1 = IXX_sample([1,1,0],[0,0,1],'cuboid',[2,3,4]);
s2 = IXX_sample([1,1,0],[0,0,1],'cuboid',[10,15,20]);
s3 = IXX_sample([1,1,0],[0,0,1],'cuboid',[0.5,0.7,1]);
...
snew = IXX_sample([1,1,0],[0,0,1],'cuboid',[2,3,4]);
