...
if tf_ver==1
    ...
    [w110arr2_tf,fp110arr2]=tobyfit(w110arr,@testfunc_sqw_bcc_hfm,[amp,sj,fwhh],[],pbind,@testfunc_bkgd,[const,grad],'local_fore','list',3,'mc_npoints',10);
