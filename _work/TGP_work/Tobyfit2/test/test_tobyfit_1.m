function varargout=test_tobyfit_1 (option)
...
%
% Perform tests:
%   >> test_tobyfit_1               % Run the tests for a visual check of output only
%
...
%                                   % tests.
%
%   >> test_tobyfit_1 ('-test')     % Run the Tobyfit tests and test against stored fit
