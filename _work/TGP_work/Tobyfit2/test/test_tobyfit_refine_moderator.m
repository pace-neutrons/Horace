function res=test_tobyfit_refine_moderator (varargin)
% Test Tobyfit moderator refinement
%
%   >> test_tobyfit_refine_moderator           % Use previously saved sqw input data file
%   >> test_tobyfit_refine_moderator ('save')  % Save test files to disk
