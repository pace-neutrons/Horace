function [mc_contrib,ok,mess] = mc_contributions_parse (varargin)
...
% component names)
%   >> [mc_contrib,ok,mess] = mc_contributions_parse
%
%   >> [mc_contrib,ok,mess] = mc_contributions_parse ('all')    % all contributions
%   >> [mc_contrib,ok,mess] = mc_contributions_parse ('none')   % no contributions
%
% All components included except...
%   >> [mc_contrib,ok,mess] = mc_contributions_parse ('nomoderator')
%   >> [mc_contrib,ok,mess] = mc_contributions_parse ('nomoderator','nochopper')
%
% Only include...
%   >> [mc_contrib,ok,mess] = mc_contributions_parse ('chopper','sample')
%
% Modify an existing Monte Carlo contriburions structure:
%   >> [mc_contrib,ok,mess] = mc_contributions_parse (mc_contrib_in,'moderator','nochopper')


% For use in other routines:
%   >> [mc_contrib,ok,mess] = mc_contributions_parse (mc_contrib_in)
