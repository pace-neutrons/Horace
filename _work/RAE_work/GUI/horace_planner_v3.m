function varargout = horace_planner_v3(varargin)
% HORACE_PLANNER_V3 M-file for horace_planner_v3.fig
%      HORACE_PLANNER_V3, by itself, creates a new HORACE_PLANNER_V3 or raises the existing
%      singleton*.
%
%      H = HORACE_PLANNER_V3 returns the handle to a new HORACE_PLANNER_V3 or the handle to
%      the existing singleton*.
%
%      HORACE_PLANNER_V3('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in HORACE_PLANNER_V3.M with the given input arguments.
%
%      HORACE_PLANNER_V3('Property','Value',...) creates a new HORACE_PLANNER_V3 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before horace_planner_OpeningFunction gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to horace_planner_v3_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help horace_planner_v3

% Last Modified by GUIDE v2.5 24-Feb-2017 15:40:46

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @horace_planner_v3_OpeningFcn, ...
                   'gui_OutputFcn',  @horace_planner_v3_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before horace_planner_v3 is made visible.
function horace_planner_v3_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to horace_planner_v3 (see VARARGIN)

% Choose default command line output for horace_planner_v3
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes horace_planner_v3 wait for user response (see UIRESUME)
% uiwait(handles.Planner);


% --- Outputs from this function are returned to the command line.
function varargout = horace_planner_v3_OutputFcn(hObject, eventdata, handles) 
