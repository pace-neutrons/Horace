classdef rundatah < rundata
    ...
    methods
        ...
        function [urange,u_to_rlu,pix] = calc_projections(obj)
            % main function to transform rundatah information into
            % crystal cartezian coordinate system
            %
            % Usage:
            %>> [urange,u_to_rlu,pix] = rh.calc_projections()
            ...
            [data.S,data.ERR,data.en,efix,emode,alatt,angdeg,u,v,psi,omega,dpsi,gl,gs,det]=...
                get_rundata(obj,'S','ERR','en','efix','emode','alatt','angdeg','u','v',...
            ...
            [u_to_rlu,urange,pix] = calc_projections_(...
                efix, emode, alatt, angdeg, u, v, psi,...
