...
% -------------------------------------------------------
%   >> [wout, fitdata] = fit_legacy_func (w, func, pin)
%   >> [wout, fitdata] = fit_legacy_func (w, func, pin, pfree)
%   >> [wout, fitdata] = fit_legacy_func (w, func, pin, pfree, pbind)
%
...
% --------------------------------------------------------
%   >> [wout, fitdata] = fit_legacy_func (..., bkdfunc, bpin)
%   >> [wout, fitdata] = fit_legacy_func (..., bkdfunc, bpin, bpfree)
%   >> [wout, fitdata] = fit_legacy_func (..., bkdfunc, bpin, bpfree, bpbind)
%
%
...
%
%   >> [wout, fitdata] = fit_legacy_func (..., keyword, value, ...)
%
...
%
%   EXAMPLES:
%   >> [wout, fitdata] = fit_legacy_func(...,'keep',[0.4,1.8],'list',2)
%
%   >> [wout, fitdata] = fit_legacy_func(...,'select')
%
...
%
%   >> [wout, fitdata, ok, mess] = fit_legacy_func (...)
%
%
%------------------------------------------------------------------------------
% Description in full
...
%   >> [wout, fdata] = fit_legacy_func(w, @gauss2d, [ht,x0,y0,var_x,0,var_y], [1,1,1,0,0,0])
%
% Allow all parameters to vary, but remove two rectangles from the data
%   >> ht=100; x0=1; y0=3; var_x=2; var_y=1.5;
%   >> [wout, fdata] = fit_legacy_func(w, @gauss2d, [ht,x0,y0,var_x,0,var_y], ...
