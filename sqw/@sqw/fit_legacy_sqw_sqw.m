...
% Fit a model for S(Q,w) to an sqw object, with an optional background
...
%   first_line = {'% Fit a model for S(Q,w) to an sqw object, with an optional background',...
%                 '% function that is also a model for S(Q,w).'}
%   main = false;
%   method = true;
%   synonymous = false;
...
%   doc_backfunc = fullfile(sqw_doc,'doc_fitfunc_sqw_sqw.m')
%
