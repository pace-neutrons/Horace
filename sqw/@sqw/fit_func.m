...
%   <a href="matlab:help('sqw/multifit_func');">click here</a>.
%
%   Help for the legacy operation can be <a href="matlab:help('sqw/fit_legacy_func');">found here</a>]
...
% -----------------------------------------------------------------------------
% <#doc_beg:> multifit
%   <#file:>  <doc_deprecated_fit>  sqw/  _func
% <#doc_end:>
%-------------------------------------------------------------------------------
