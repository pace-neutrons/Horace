...
%                           resolution function. 
%       'mc_npoints'        Sets the nmumber of Monte Carlo samplings per 
%                           pixel 
%       'refine_crystal'    Options controlling refinement of crystal 
%                           orienetation and lattice parameters 
...
% 
%   'mc_npoints'        Sets the nmumber of Monte Carlo samplings per pixel. 
%                       e.g. (...,'mc_npoints',100,...) 
%                       Default: 10 (usually good for a first estimate) 
% 
%   'refine_crystal'    Options controlling refinement of crystal orienetation 
...
%   doc_custom_keywords_short = 'sqw_doc:::doc_tobyfit_keywords_short.m'; 
%   doc_custom_keywords_long  = 'sqw_doc:::doc_tobyfit_keywords_long.m'; 
% 
% <#doc_beg:> 
