function b_mat =  b_matrix_DGfermi (wi, wf, x0, xa, x1, x2, thetam, angvel, s_mat, d_mat, k_to_v)
% Compute matrix for computing deviations in (ki,kf) (in Ang^-1) from deviations in tm, tch, x, y, z etc.
%
%   >> b_mat = b_matrix_DGfermi (wi, wf, x0, xa, x1, x2, thetam, angvel, s_mat, d_mat, k_to_v)
%
