function [y,varargout] = rand_mvgauss(mu,Sigma,N)
%RAND_MVGAUSS    Multivariate Gaussian random number generator.
%
% Rename of mvg by Chad Lieberman, downloaded from Mathwork file exchange July 2023
%-------------------------------------------------------------------------------
...
%
%-------------------------------------------------------------------------------
% Mathworks File Exchange citation:
%   Chad Lieberman (2023). MVG Multivariate Gaussian random number generator
%  (https://www.mathworks.com/matlabcentral/fileexchange/...
%   21279-mvg-multivariate-gaussian-random-number-generator), 
%   MATLAB Central File Exchange. Retrieved July 13, 2023.
%-------------------------------------------------------------------------------
