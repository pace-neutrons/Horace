...
% Plot markers and errorbars for an array of one-dimensional datasets
...
[icol, iwid, ityp, isiz] = property_index (nw, color_cycle, numel(colors), ...
    numel(line_widths), numel(marker_types), numel(marker_sizes));
