function write_string_sign(group_id,ds_name,ds_contents_string,attr_name,attr_cont)
...
H5T.set_size (filetype, numel(ds_contents_string));
memtype = H5T.copy ('H5T_C_S1');
H5T.set_size (memtype, numel(ds_contents_string));

space = H5S.create_simple (1,1, 1);
dataset_id = H5D.create (group_id, ds_name, filetype, space, 'H5P_DEFAULT');
H5D.write (dataset_id, memtype, 'H5S_ALL', 'H5S_ALL', 'H5P_DEFAULT', ds_contents_string);
