...
% Variance of depth of absorption in a 3He tube
%
%   >> val = var_d_alf (alf)
%
% Input:
...
% Output:
% -------
%   val     Variance of depth of aborption along the neutron path as a
%          fraction of half the maximum distance along the neutron flight
%          path squared (same size and shape as alf)
%
%
