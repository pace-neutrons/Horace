...
% Mean depth of absorption in a 3He tube
%
%   >> val = mean_d_alf (alf)
%
% Input:
...
% Output:
% -------
%   val     Mean depth of absorption along the neutron path with respect to
%          axis of tube as a fraction of half the maximum distance along the
%          neutron flight path (same size and shape as alf)
%
%
