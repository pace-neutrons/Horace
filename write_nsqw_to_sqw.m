...
for i=1:nfiles
    [main_header{i},header{i},det_tmp,datahdr{i},mess,position,npixtot(i),type] = sqw_get (infiles{i},'-h');
...
run_label='fileno';
mess = sqw_put (outfile, main_header_combined, header, det, sqw_data, '-pix', infiles, pos_npixstart, pos_pixstart, run_label);
