function wout = single_mpower(w1,w2,class_type)
% Implement w1 ^ w2
%
%   >> w = w1 ^ w2
%
...
%         w2.s(w2nan) = 0;            w2.e(w2nan) = 0;
        ...
        wout.s = w1.s .^ w2.s;
        wout.e = w1.e.*((w2.s.*(w1.s.^(w2.s-1))).^2) + w2.e.*((wout.s.*log(w1.s)).^2);
