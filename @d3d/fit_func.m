...
% Fits a function to a d3d object, with an optional background function. 
% 
...
% 
% Differs from multifit_func, which fits all datasets in the array 
% simultaneously but with independent backgrounds. 
% 
% Fit several datasets in succession to a given function: 
% ------------------------------------------------------- 
%   >> [wout, fitdata] = fit_func (w, func, pin) 
%   >> [wout, fitdata] = fit_func (w, func, pin, pfree) 
%   >> [wout, fitdata] = fit_func (w, func, pin, pfree, pbind) 
% 
...
% ========= 
% 
% The examples for d1d and d2d objects illustrate the use of fit_func, 
% although the dimensionality of the examples is different. Type 
% >> help d1d/fit_func  or >> help d2d/fit_func  and look at the examples. 
 
% <#doc_def:> 
%   first_line = {'% Fits a function to a d3d object, with an optional background function.'} 
%   main = false; 
%   method = true; 
%   synonymous = false; 
% 
