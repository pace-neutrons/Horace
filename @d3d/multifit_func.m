...
% 
% Differs from fit_func, which independently fits each dataset in 
% succession. 
% 
% Simultaneously fit datasets to a single function ('global foreground'): 
% ----------------------------------------------------------------------- 
%   >> [wout, fitdata] = multifit_func (w, func, pin) 
%   >> [wout, fitdata] = multifit_func (w, func, pin, pfree) 
%   >> [wout, fitdata] = multifit_func (w, func, pin, pfree, pbind) 
% 
...
%   >> [wout, fitdata] = multifit_func (..., 'local_foreground') 
% 
...
%   >> [wout, fitdata] = multifit_func (..., 'global_background') 
% 
% 
...
% 
%   EXAMPLES: 
%   >> [wout, fitdata] = multifit_func(...,'keep',[0.4,1.8],'list',2) 
% 
%   >> [wout, fitdata] = multifit_func(...,'select') 
% 
...
% ========= 
% 
% The examples for d1d and d2d objects illustrate the use of multifit_func, 
% although the dimensionality of the examples is different. Type 
% >> help d1d/multifit_func  or >> help d2d/multifit_func  and look at the 
% examples. 
...
%   obj_name = 'd3d' 
% 
%   doc_forefunc = 'sqw_doc:::doc_fitfunc_d3d_simple.m' 
%   doc_backfunc = 'sqw_doc:::doc_fitfunc_d3d_simple.m' 
% 
