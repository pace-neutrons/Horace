...
% 
% Differs from multifit_sqw_sqw, which fits all datasets in the array 
% simultaneously but with independent backgrounds. 
% 
% Fit several datasets in succession to a given function: 
% ------------------------------------------------------- 
%   >> [wout, fitdata] = fit_sqw_sqw (w, func, pin) 
%   >> [wout, fitdata] = fit_sqw_sqw (w, func, pin, pfree) 
%   >> [wout, fitdata] = fit_sqw_sqw (w, func, pin, pfree, pbind) 
% 
...
% ========= 
% 
% The examples for d1d objects illustrate the use of fit_sqw_sqw, although the 
% dimensionality of the examples is different. Type  >> help d1d/fit_sqw_sqw 
...
%   doc_backfunc = 'sqw_doc:::doc_fitfunc_dnd_sqw.m' 
% 
