...
%   <a href="matlab:help('d3d/multifit');">click here</a>.
%
%   Help for the legacy operation can be <a href="matlab:help('d3d/fit_legacy');">found here</a>]
