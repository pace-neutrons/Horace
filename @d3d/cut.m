...
% Take a cut from a d3d object or array of objects by integrating over one or more of the plot axes.
% 
% Syntax:
%  make cut:
...
% Input:
% ------
%   data_source     Data source: sqw file name or d3d-type data structure
%
