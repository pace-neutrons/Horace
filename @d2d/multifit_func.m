...
%   >> [wout, fdata] = multifit_func(w, @gauss2d, [ht,x0,y0,var_x,0,var_y], [1,1,1,0,0,0]) 
% 
...
%   >> [wout, fdata] = multifit_func(w, @gauss2d, [ht,x0,y0,var_x,0,var_y], ... 
...
%   obj_name = 'd2d' 
% 
%   doc_forefunc = 'sqw_doc:::doc_fitfunc_d2d_simple.m' 
