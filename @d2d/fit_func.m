...
%   <a href="matlab:help('d2d/multifit_func');">click here</a>.
%
%   Help for the legacy operation can be <a href="matlab:help('d2d/fit_legacy_func');">found here</a>]
...
% -----------------------------------------------------------------------------
% <#doc_beg:> multifit
%   <#file:>  <doc_deprecated_fit>  d2d/  _func
% <#doc_end:>
%-------------------------------------------------------------------------------
