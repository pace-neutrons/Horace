...
% Fit a model for S(Q,w) to a d2d object, with an optional background function. 
% 
...
% <#doc_def:> 
%   first_line = {'% Fit a model for S(Q,w) to a d2d object, with an optional background function.'} 
%   main = false; 
%   method = true; 
%   synonymous = false; 
% 
