...
hor_init_dir = find_directory( ...
    'horace_init.m', ...
    { ...
        fullfile(install_root, 'Horace'), ...
        fullfile(opts.horace_root, 'horace_core') ...
    } ...
);
her_init_dir = find_directory( ...
    'herbert_init.m', ...
    {
        fullfile(install_root, 'Herbert'), ...
        fullfile(opts.herbert_root, 'herbert_core') ...
    } ...
);
...
horace_on_path = find_file( ...
    ...
    { ...
        install_root, ...
        fullfile(opts.horace_root, 'admin'), ...
    } ...
);
install_file( ...
    horace_on_path, ...
...
herbert_on_path = find_file( ...
    ...
    { ...
        install_root, ...
        fullfile(opts.herbert_root, 'admin'), ...
    } ...
);
install_file( ...
    herbert_on_path, ...
