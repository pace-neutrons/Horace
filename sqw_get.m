function [main_header,header,detpar,data,mess,position,npixtot,type] = sqw_get (infile,varargin)
% Load an sqw file from disk
%
% Syntax:
%   >> [main_header, header, detpar, data, position, npixtot] = sqw_get (infile)
%   >> [main_header, header, detpar, data, position, npixtot] = sqw_get (infile, opt)
%   >> [main_header, header, detpar, data, position, npixtot] = sqw_get (infile, npix_lo, npix_hi)
%
% Input:
% --------
