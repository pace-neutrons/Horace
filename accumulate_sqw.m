...
%
% Differs from gen_sqw because it will add data to an existing sqw file,
% provide the data ranges match.
%
% Normal use:
...
[tmp_file,grid_size,urange] = accumulate_sqw (sqw, varargin{:});
