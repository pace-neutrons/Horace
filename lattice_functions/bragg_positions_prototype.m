function [rlu0,width,wcut,wpeak]=bragg_positions_prototype(w, rlu, cut_length, cut_thickness, bin_width, energy_window)
...
% Banner
disp('================================================================================')
disp('       ***    This function was a prototype and is now redundant   ***')
disp('   Please use function bragg_positions instead (type >> help bragg_positions)')
disp('================================================================================')
