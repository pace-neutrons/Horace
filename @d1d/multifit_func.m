...
%   >> [wfit,fitpar]=multifit_func(w,@gauss,pin,@linear_bg,bg) 
% 
% Remove a portion of the data, and give copious output during the fitting 
% - remove a common range: 
%   >> [wfit,fitpar]=multifit_func(w,@gauss,pin,@linear_bg,bg,'remove',... 
%                                             [12,14],'list',2) 
...
% 
%   >> [wfit,fitpar]=multifit_func(w,@gauss,pin,[1,0,1],@linear_bg,bg,... 
%                             {{1,3,-1},{2,1,-1,1e-3}}) 
% 
% Fit independent Gaussians but which are constrained to have the same 
% widths 
% 
%   >> [wfit,fitpar]=multifit_func(w,@gauss,pin,{{},{3,3,1}},@linear_bg,bg,... 
%                                         'local_foreground') 
...
%   obj_name = 'd1d' 
% 
%   doc_forefunc = 'sqw_doc:::doc_fitfunc_d1d_simple.m' 
%   doc_backfunc = 'sqw_doc:::doc_fitfunc_d1d_simple.m' 
% 
