...
%   <a href="matlab:help('d1d/multifit');">click here</a>.
%
%   Help for the legacy operation can be <a href="matlab:help('d1d/fit_legacy');">found here</a>]
