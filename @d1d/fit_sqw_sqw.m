...
% Fit a model for S(Q,w) to an object, with an optional background function that is also a model for S(Q,w)
% If passed an array of objects, then each object is fitted independently.
%
% For full help, read documentation for sqw object fit_sqw_sqw:
%   >> help sqw/fit_sqw_sqw
%
