function [title_main, title_pax, title_iax, display_pax, display_iax, energy_axis] = sqw_data_plot_titles (data)
% Get titling and caption information for an sqw data structure
%
% Syntax:
%   >> [title_main, title_pax, title_iax, display_pax, display_iax, energy_axis] = sqw_data_plot_titles (w)
% 
% Input:
% ------
%   data            Structure for which titles are to be created from the data in its fields.
%                   Type >> help sqw_check_data for a full description of the fields
%
% Output:
% -------
