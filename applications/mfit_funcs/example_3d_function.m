function y = example_3d_function(x1, x2, p)
% Example fitting function three dimensions
% -------------------------------------------------------------------------
% A three-dimensional fit function must have the form:
%
...
%
% where
%  	x1, x2, x3  Arrays of x values, x1 containing the values of the 
%              coordinates along the first dimension, and x2, x3 containing
%              the values along the second and third dimensions. All arrays
...
%
% See also linear3D_bg
%
% -------------------------------------------------------------------------
% This example is a three-dimensional Gaussian:
% 
...
%   x3  Array of values at which to evaluate function along the first
%      dimension. Must have the same size as x1
