...
%   func        Foreground function handle
%   plist       Foreground parameter list
...
% *** This is for the original multifit function that only allowed a global
%     foreground function
...
plist_new=[{func,plist},fwrap_par];
...
if ~isempty(bpos)
    ...
    if numel(bfunc)==1
        bplist_new{1}=[{bfunc{1},bplist{1}},bfwrap_par];
    else
