...
% Set the initial values of foreground function parameters
%
% Set initial values for all foreground functions
%   >> obj = obj.set_pin (pin)
%
% Set for one or more specific foreground function(s)
%   >> obj = obj.set_pin (ifun, pin)
%
% Input:
% ------
