...
%
% Independently fit several objects to a given function:
...
%
% With optional 'background' function added to the foreground
...
%   -----------------------------
%   It is sometimes convenient to fit a foreground function, func, to the collection of objects w,
...
% Determine the number of datasets to be fitted. Doesn't need to do the full deconstruction of multifit
% but needs to do some; so ensure synchronised with multifit if ever make any changes there.
%           - Structure with fields w.x, w.y, w.e  with form described above  (this is a single dataset)
%           - Array of structures w(i).x, w(i).y, w(i).e  with form above (this defines several datasets)
%           - Cell array of structures, each element a single dataset
%           - Array of objects to be fitted.
%           - Cell array of objects to be fitted.
