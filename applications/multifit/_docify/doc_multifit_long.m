...
%           then the function must have the form:
    <#file:> multifit_doc:::doc_func_simple.m
%
%           If fitting objects, then if w is an instance of an object, the
%           function(s) or method(s) must have the form:
    <#file:> multifit_doc:::doc_func_obj.m
%
    <#file:> multifit_doc:::doc_func_advanced_use.m
<MAIN/END:>
%
...
%       
%
<#FILE:> multifit_doc:::doc_keywords_long.m
%
%
% Output:
% =======
