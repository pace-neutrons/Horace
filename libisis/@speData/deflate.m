...
% Remove the spe data from memory to save memory.
% If the data are initially in ASCII fomat, it also writes the data file in hdf5
% format for faster access in a future, if
%
