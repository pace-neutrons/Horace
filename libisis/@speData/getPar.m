...
% Returns phx data contained in spe data structure if such data exist;
%
%   >> par =get_par(speData)
%
% Returns empty array if phx data is not in the spe data structure.
% Phx data usually loaded to spe structure from nxspe file.
