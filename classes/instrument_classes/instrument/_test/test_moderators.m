ff0 = IX_moderator(10,13,'ikcarp',[5,25,0.4]);
...
nn=IX_moderator(0,0,'ikcarp_par',pp,'uniform',[],0,0,0,0,100);
ynew=pulse_shape(nn,t);
wnew=IX_dataset_1d(t,ynew);
