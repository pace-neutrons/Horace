...
det1 = IX_He3tube (dia1, height1, thick1, atms1, th1);
det2 = IX_He3tube (dia2, height2, thick2, atms2, th2);
det3 = IX_He3tube (dia3, height3, thick3, atms3, th3);
det4 = IX_He3tube (dia4, height4, thick4, atms4, th4);
det5 = IX_He3tube (dia5, height5, thick5, atms5, th5);
...
det_1_3 = IX_He3tube (dia_1_3, height_1_3, thick_1_3, atms_1_3, th_1_3);
det_3_5 = IX_He3tube (dia3, height3, thick3, [atms3,atms4,atms5], th3);
...
detarr_big1 = IX_He3tube (dia1, height_big1, thick1, atms1, th1);
detarr_big2 = IX_He3tube (dia2, height_big2, thick2, atms2, th2);
