...
[t_cov(:,:,8),t_av(:,8)] = moments_2D (self, alf);

% mod-shape-chop = [1,1,0]
[t_cov(1,1,7),t_av(1,7)] = moments_1D (moderator, shaping_chopper, alf);
