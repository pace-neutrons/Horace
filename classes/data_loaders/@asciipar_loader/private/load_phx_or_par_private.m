function [loader,det]=load_phx_or_par_private(loader,return_array,lext)
...
switch lext
    ...
    otherwise
        error('ASCIIPAR_LOADER:load_par','unknown file extension for file %s',this.par_file_name);
end
