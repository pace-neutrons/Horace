...
%   >> test_gen_sqw_powder           % Compare with previously saved results in test_rebin_output.mat
%                                    % in the same folder as this function
%   >> test_gen_sqw_powder ('save')  % Save to test_rebin_output.mat in tempdir (type >> help tempdir
