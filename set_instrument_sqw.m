function varargout=set_instrument_sqw(varargin)
% Change the instrument in a file or set of files containing Horace sqw data
%
%   >> set_instrument_sqw (file, instrument)
%
...
[varargout,mess] = horace_function_call_method (nargout, @set_instrument, '$sqw', varargin{:});
