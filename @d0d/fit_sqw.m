...
% Fit model for S(Q,w) to 0D dataset object or array of 0D dataset objects. If passed
...
% Input:
% ======
%   win     0D dataset object or array of 0D dataset objects to be fitted
%
...
% Output:
% =======
%   wout    0D dataset object containing the evaluation of the function for the
