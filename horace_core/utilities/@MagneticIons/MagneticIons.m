classdef MagneticIons
    ...
    properties(Dependent)
        ...
        currentIon
        % Current Ion fitting Parameters, used in interpolation formula
        fitting_param
    ...
    methods
        ...
        function par = get.fitting_param(obj)
            par = obj.IonParMap_(obj.currentIon_);
        end
        %------------------------------------------------------------------
        % Interfaces:
        %
    ...
    properties(Constant, Access=private)
        ...
        Ions_ = {'Sc0','Sc1','Sc2','Ti0','Ti1','Ti2','Ti3',...
            ...
            'Co0','Co1','Co2','Co3','Co4','Ni0','Ni1','Ni2','Ni3','Ni4',...
            'Cu0','Cu1','Cu2','Cu3','Cu4','Y0','Zr0','Zr1','Nb0','Nb1',...
            'Mo0','Mo1','Tc0','Tc1','Ru0','Ru1','Rh0','Rh1','Pd0','Pd1',...
            'Ce2','Nd2','Nd3','Sm2','Sm3','Eu2','Eu3','Gd2','Gd3',...
            'Tb2','Tb3','Dy2','Dy3','Ho2','Ho3','Er2','Er3','Tm2','Tm3',...
            'Yb2','Yb3','U3','U4','U5','Np3','Np4','Np5','Np6',...
            'Pu3','Pu4','Pu5','Pu6','Am2','Am3','Am4','Am5','Am6','Am7'}
