...
if ismember(newIonName,self.Ions_)
    ...
    [self.J0_ff_,self.J2_ff_,self.J4_ff_,self.J6_ff_]=MagneticIons.getInterpolant(self.currentIon_);
else
    error('HORACELMagneticIons:invalid_argument', ...
        'Ion with name %s is not currently supported',newIonName)
end
%
