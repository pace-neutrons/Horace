...
if nargin==2
    if isa(win,'sqw_old') && (isa(varargin{1},'sqw_old') || ...
            isa(varargin{1},'d1d_old') || isa(varargin{1},'d2d_old') || isa(varargin{1},'d3d'))
    ...
    case 1
        ...
        elseif ndimsin==2
            ...
            if all(crossprod<1e-5) && ~energy_axis
                ...
                wout=sqw_old(wout);%convert from structure array to sqw object
                %
            ...
            elseif all(crossprod<1e-5) && energy_axis
                ...
                %
                wout=sqw_old(wout);%convert back to sqw from structure array
                %
                wout=cut(wout,xbin,ybin);
            else
