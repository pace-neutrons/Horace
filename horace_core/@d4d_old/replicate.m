...
% Input:
% ------
%   win     Four dimensional dataset or array of datasets. The signal, error
...
if isa(win,classname)
    if isscalar(wref) && (isa(wref,'d0d_old')||isa(wref,'d1d_old')||isa(wref,'d2d_old')||isa(wref,'d3d_old')||isa(wref,'d4d_old'))
