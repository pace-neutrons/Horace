...
%   <a href="matlab:help('d4d/multifit');">click here</a>.
%
%   Help for the legacy operation can be <a href="matlab:help('d4d/fit_legacy');">found here</a>]
