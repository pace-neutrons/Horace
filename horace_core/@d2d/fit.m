...
%   <a href="matlab:help('d2d/multifit');">click here</a>.
%
%   Help for the legacy operation can be <a href="matlab:help('d2d/fit_legacy');">found here</a>]
