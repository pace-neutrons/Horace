...
if ~ok, error(mess), end
if nw==2
    [figureHandle_, axesHandle_, plotHandle_] = ps2oc(IX_dataset_2d(w), IX_dataset_2d(varargin{1}), args{:});
else
    [figureHandle_, axesHandle_, plotHandle_] = ps2oc(IX_dataset_2d(w), args{:});
end
