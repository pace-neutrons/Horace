...
%   >> [wout, fitdata] = multifit_legacy_func (..., 'local_foreground')
%
...
%   >> [wout, fitdata] = multifit_legacy_func (..., 'global_background')
%
%
...
%   >> [wout, fdata] = multifit_legacy_func(w, @gauss2d, [ht,x0,y0,var_x,0,var_y], [1,1,1,0,0,0])
%
...
%   >> [wout, fdata] = multifit_legacy_func(w, @gauss2d, [ht,x0,y0,var_x,0,var_y], ...
...
%   obj_name = 'sqw'
%
%   doc_forefunc = fullfile(sqw_doc,'doc_fitfunc_sqw_simple.m')
