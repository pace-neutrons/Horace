...
%   <a href="matlab:help('sqw/multifit_sqw');">click here</a>.
%
%   Help for the legacy operation can be <a href="matlab:help('sqw/fit_legacy_sqw');">found here</a>]
...
% -----------------------------------------------------------------------------
% <#doc_beg:> multifit
%   <#file:>  <doc_deprecated_fit>  sqw/  _sqw
% <#doc_end:>
%-------------------------------------------------------------------------------
