...
expdata = struct( ...
    ...
    "run_id", 1);
%{
% original detpar - left here for any future use.
% replaced below.
out.detpar = struct( ...
    'filename', 'fake', ...
    'filepath', '/fake', ...
...
% detpar is generated from detector_arrys so that detpar and
% detector_arrays are consistent.
out.detpar = detector_arrays.det_bank(1).detpar;
