function qw=calculate_qw_pixels3(win,rrr,ddd,eee,coord_in_rlu,return_array)
%function varargout=calculate_qw_pixels3(www,varargin)
%win = varargin{1};
%{
rrr=varargin{1};
ddd=varargin{2};
eee=varargin{3};
coord_in_rlu = varargin{4};
return_array = varargin{5};
%}
%%{
