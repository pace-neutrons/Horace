function [s, e, npix, img_range_step, pix, npix_retain, npix_2read] = cut_data_from_file (fid, nstart, nend, keep_pix, pix_tmpfile_ok,...
    proj,pax, nbin)
...
try
    for i=1:nsteps
        ...
        %
        % -- cut
        [s, e, npix, img_range_step, del_npix_retain, ok, ix_add] = accumulate_cut (s, e, npix, img_range_step, keep_pix, ...
            v, proj, pax);
