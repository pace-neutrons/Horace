function [set_single,set_per_obj,n_runs_in_obj]=find_set_mode_(obj,varargin)
% Helper function for various set component Tobyfit methods
% given array of values to set on array of objects, identify how these
% values should be distributed among objects
%
%Inputs:
% obj       -- single sqw object or array of sqw objects
