function [cov_proj, cov_spec, cov_hkle] = tobyfit_DGfermi_resfun_covariance(win, ipix)
...
%
% For selected pixels:
%   >> [cov_spec, cov_proj, cov_hkle] = tobyfit_DGfermi_resfun_covariance (w, ipix)
%
%
% Input:
% ------
...
if exist('ipix','var')
    all_pixels = false;
    [ok,mess,lookup,npix_arr] = tobyfit_DGfermi_resconv_init (win, ipix);
else
    all_pixels = true;
