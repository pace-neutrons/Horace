function [u_to_rlu, pix_range,pix]= get_test_calc_projections(sqw,...
...
[u_to_rlu, pix_range,pix]=calc_projections (efix, emode, alatt, angdeg, u, v, psi_rad, omg_rad, dpsi_rad, gl_rad, gs_rad, data, det);
