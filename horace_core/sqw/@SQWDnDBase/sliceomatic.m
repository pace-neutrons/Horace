...
pax = w.data_.pax;
dax = w.data_.dax;                 % permutation of projection axes to give display axes
ulabel = w.data_.ulabel(pax(dax)); % labels in order of the display axes
ulen = w.data_.ulen(pax(dax));     % unit length in order of the display axes
