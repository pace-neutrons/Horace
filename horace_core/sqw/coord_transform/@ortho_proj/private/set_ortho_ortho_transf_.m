...
[pix_to_img_source,shift_source]= obj.get_pix_img_transformation(3);
[pix_to_img_targ,shift_targ]    = targ_proj.get_pix_img_transformation(3);

obj.ortho_ortho_offset_ = pix_to_img_targ'*(shift_source(:)-shift_targ(:));
obj.ortho_ortho_offset_ = [obj.ortho_ortho_offset_;obj.offset(4)-targ_proj.offset(4)];

obj.ortho_ortho_transf_mat_ = pix_to_img_source'\pix_to_img_targ';
