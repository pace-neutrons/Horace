function img_range_out=find_ranges_(this,img_range_in)
% ------------------------------------------------------------------------
...
[x1,x2,x3]=ndgrid(img_range_in(:,1)-trans(1),img_range_in(:,2)-trans(2),img_range_in(:,3)-trans(3));
vertex_in=[x1(:)';x2(:)';x3(:)'];
vertex_out = rot*vertex_in;
img_range_out=[[min(vertex_out,[],2)';max(vertex_out,[],2)'],img_range_in(:,4)];  % 2x4 array of limits in output proj. axes
