classdef PageOp_sqw_binning < PageOp_sqw_eval
    ...
    methods
        ...
        function obj = get_page_data(obj,idx,npix_blocks)
            ...
            %
            if isa(obj.pix_,'MultipixBase')
                % knowledge of all pixel coordinates in a cell.
        ...
        function obj = apply_op(obj,varargin)
            ...
            if obj.do_nopix_
                [obj.proj,obj.npix_acc_,obj.sig_acc_,obj.var_acc_] = obj.proj.bin_pixels(...
                    obj.img_.axes,pix, ...
                ...
                if filebacked_processing
                    ...
                    [obj.proj,obj.npix_acc_,obj.sig_acc_,obj.var_acc_, pix_ok,...
