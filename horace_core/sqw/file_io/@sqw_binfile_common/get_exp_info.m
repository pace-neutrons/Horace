...
%
% Usage:
%>>header = loader.get_exp_info() % -- returns sqw headers
% or
%>>header = loader.get_exp_info(n_header) % returns header number n_header
%
...
if ischar(obj.num_contrib_files)
    error('HORACE:sqw_binfile_common:runtime_error',...
        ' get_exp_info called on un-initialized loader')
end
