...
if uint64(pix_end) > uint64(file_end)
    ...
    warning( ...
        'FACCESS_SQW_V3:runtime_error', ...
        [ ...
            'Expected %d but written %d pixels. File end position %d is ' ...
            'smaller than pixel end position: %d\n%s' ...
        ], ...
        npix_expected, ...
        npix_written, ...
        file_end, ...
        pix_end, ...
        [ ...
            'Missing pixels: waiting 10 sec to flush filesystem in hope that ' ...
            'pixels will be written.' ...
        ] ...
    );
    for i=1:10
        fprintf('.')
