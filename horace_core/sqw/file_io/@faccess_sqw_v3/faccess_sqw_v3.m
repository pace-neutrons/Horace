classdef faccess_sqw_v3 < sqw_binfile_common
    ...
    methods(Access=protected)
        ...
        function [instr_str,sampl_str] = get_instr_sample_to_save(~,exp_info)
            ...
            instr = exp_info.instruments.unique_objects;
            % get_unique_samples as a cell array;
            sampl = exp_info.samples.unique_objects;
            % convert to structs
        ...
        % format v3.1 to file format version 3.3. Recent file format defines 
        % common transformations in sqw_binfile_common
        % so this function is defined there and removed from here as 
        % it was for v3.3 file formats.
