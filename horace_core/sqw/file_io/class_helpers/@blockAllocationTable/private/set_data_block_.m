...
[initialized,present,start_position,size] = cellfun(@(x)block_info(x,targ_name), ...
    obj.blocks_list_);
...
obj.blocks_list_(present) = block_instance;
first_pos = [obj.obj.blocks_start_position,first_pos,targ_start];
next_pos   = [next_pos,obj.end_of_file_pos-1,targ_end];
