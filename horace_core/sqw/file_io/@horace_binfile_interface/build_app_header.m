...
%           file, described by the header. If not, the instance of the
%           object will be taken from sqw_holder property.
%
%           If no SQWDnDBase object instance is defined, the method will
...
if isempty(obj_to_save)
    error('HORACE:horace_binfile_interface:invalid_argument',...
        'Trying to build_app_header but no object to build header from is provided')
end
