...
% Overplot markers, error bars and lines for a 1D sqw object or 
% array of objects on an existing plot
%
%   >> pd(w)
%
% Advanced use:
...
% Perform plot
[figureHandle_, axesHandle_, plotHandle_] = pd(IX_dataset_1d(w), args{:});
