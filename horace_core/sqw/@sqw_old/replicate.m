...
elseif ~(isa(win,'d0d_old')||isa(win,'d1d_old')||isa(win,'d2d_old')||isa(win,'d3d')||isa(win,'d4d'))
...
elseif isscalar(wref) && (isa(wref,'d0d_old')||isa(wref,'d1d_old')||isa(wref,'d2d_old')||isa(wref,'d3d')||isa(wref,'d4d'))
