...
%   <a href="matlab:help('sqw/multifit');">click here</a>.
%
%   Help for the legacy operation can be <a href="matlab:help('sqw/fit_legacy');">found here</a>]
