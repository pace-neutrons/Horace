...
%   <a href="matlab:help('d3d/multifit_func');">click here</a>.
%
%   Help for the legacy operation can be <a href="matlab:help('d3d/fit_legacy_func');">found here</a>]
...
% -----------------------------------------------------------------------------
% <#doc_beg:> multifit
%   <#file:>  <doc_deprecated_fit>  d3d/  _func
% <#doc_end:>
%-------------------------------------------------------------------------------
