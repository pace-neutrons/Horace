function [grid_size, pix_range] = write_spe_to_sqw (spe_file, par_file, sqw_file, efix, emode, alatt, angdeg,...
...
% ------------------------------
r2d=180/pi;
[tmp_file,grid_size,pix_range] = gen_sqw (spe_file, par_file, sqw_file,...
