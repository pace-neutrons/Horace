    ...
    methods(Static)
        ...
        function [npix,varargout] = bin_pixels(proj, ...
            ...
            [npix,s,e,pix_cand,unique_runid,argi]=...
                axes_block.normalize_bin_input(grid_size,pix_coord_transf, ...
                nargout,varargin{:});

            switch(nargout)
                case(1)
                    npix=proj.bin_pixels(axes,pix_candidates,...
                        axes,pix_candidates,npix,s,e,argi{:});
                case(3)
                    [npix,varargout{1},varargout{2}]= ...
                        proj.bin_pixels(axes,pix_candidates, ...
                        npix,s,e,argi{:});
                case(4)
