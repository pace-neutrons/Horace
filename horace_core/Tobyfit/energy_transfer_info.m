...
%{
- currently commented out as it is expected that header.expdata will be a vector
if ~iscell(header.expdata) % this means it's a single run, not that it's a matrix
