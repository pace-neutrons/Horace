...
%   <a href="matlab:help('d4d/multifit_sqw_sqw');">click here</a>.
%
%   Help for the legacy operation can be <a href="matlab:help('d4d/fit_legacy_sqw_sqw');">found here</a>]
...
% -----------------------------------------------------------------------------
% <#doc_beg:> multifit
%   <#file:>  <doc_deprecated_fit>  d4d/  _sqw_sqw
% <#doc_end:>
%-------------------------------------------------------------------------------
