...
[data.int,count] = fread(fid,data.ntot,'float32');
data.int = reshape(data.int,data.nhv,data.nkv,data.nlv,data.nev);
[data.err,count] = fread(fid,data.ntot,'float32');
data.err = reshape(data.err,data.nhv,data.nkv,data.nlv,data.nev);
