classdef test_gen_array_of_tmp_file_paths < TestCase
    ...
    methods
        ...
        function test_all_output_file_names_startwith_prefix(~)
            prefix = 'MY_PREFIX';
            nfiles = 2;
            paths = gen_array_of_tmp_file_paths(nfiles, prefix, '');
        ...
        function test_all_output_paths_within_base_dir(~)
            ...
            nfiles = 2;
            paths = gen_array_of_tmp_file_paths(nfiles, 'MY_PREFIX', base_dir);
            for i = 1:numel(paths)
        ...
        function test_all_file_paths_end_with_input_file_extension(~)
            ...
            nfiles = 2;
            ext = 'my_ext';
            paths = gen_array_of_tmp_file_paths(nfiles, prefix, '', ext);
        ...
        function test_separate_calls_generate_different_UUIDs(~)
            ...
            paths_1 = gen_array_of_tmp_file_paths(1, '', '');
            match_1 = regexp(paths_1{1}, regex_pattern, 'names');

            paths_2 = gen_array_of_tmp_file_paths(1, '', '');
