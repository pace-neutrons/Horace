classdef test_sqw_copy < TestCase
    ...
    methods
        ...
        function test_copy_returns_distinct_object(obj)
            ...
            detector = sqw_copy.experiment_info.detector_arrays{1};
            dtp = detector.get_detpar_representation();
            dtp.azim(1:10) = 0;
            detector = IX_detector_array(dtp);
            sqw_copy.experiment_info.detector_arrays{1} = detector;
