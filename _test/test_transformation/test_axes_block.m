classdef test_axes_block < TestCase
    ...
    methods
        ...
        function test_get_bin_centers_2D_4d(~)
            ...
            [nodes,en,nbins] = ab.get_bin_nodes('-bin_center',(dbr(2,:)-dbr(1,:))'/10);
        ...
        function test_get_bin_centers_2D_native(~)
            ...
            [centers,en,ncenters] = ab.get_bin_nodes('-bin_center');
        ...
        function test_worong_char_size_throw(~)
            ...
            bin0 = {[dbr(1,1),0.1,dbr(2,1)];[dbr(1,2),dbr(2,2)];...
                [dbr(1,3),dbr(2,3)];[dbr(1,4),1,dbr(2,4)]};
            ab = axes_block(bin0{:});
           ex = assertExceptionThrown(@()get_bin_nodes(ab,'-bin_center',(dbr(2,:)-dbr(1,:))/10),...
