classdef test_axes_block_properties < TestCase
    ...
    methods
        ...
        function test_set_nbin_all_dim_all_2D(~)
            ...
            nbins = [1;4;1;2];
            ab = axes_block();
            ab.nbin_all_dim = nbins;
            ab.img_range = range;
            assertEqual(ab.nbin_all_dim,nbins')
            ...
            assertEqual(ab.p{1},[-0.25,0.375,1,1.625,2.25])
            assertEqual(ab.p{2},[-1,2,5]);
        ...
        function test_default_constructor(~)
            ...
            assertEqual(ab.nbin_all_dim,ones(1,4))
