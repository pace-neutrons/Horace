classdef test_ortho_proj_methods<TestCase
    ...
    methods
        ...
        function test_transformation_scale_ppp_ortho(~)
            ...
            assertElementsAlmostEqual(diag(img_coord),len);
        end

        function test_transformation_scale_aaa_nonortho_tricl(~)
        ...
        function test_transformation_scale_aaa_nonortho_eq_ortho_xy(~)
        ...
        function test_transformation_scale_aaa_nonortho_eq_ortho(~)
