...
if ~equivalent_mslice_objects(s_add,s_add_tmp), error('s_add,s_add_tmp not equivalent'), end
...
if ~equivalent_mslice_objects(s_com,s_com_tmp), error('s_com,s_com_tmp not equivalent'), end
