...
---------------------
spe_files_source.zip 			Test spe files, par file and phx file for generation of cuts and slices

test_cut_slice_files.zip 		Cut and slice files created by the m-file below. Have to manually copy 
								from the work area into this folder. Should not need to be run
								unless the test files need to be recreated.

test_spe_files.zip			spe files for tests
