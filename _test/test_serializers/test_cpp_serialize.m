classdef test_cpp_serialize < TestCase
    properties
        warned
        use_mex
        old_mex
    ...
    methods
        function this=test_cpp_serialize(varargin)
            if nargin>0
                name = varargin{1};
            else
                name  = 'test_cpp_serialize';
            end
        ...
        function test_ser_empty_det(obj)
            ...
            ss = sqw();
            ser =  c_serialize(ss.detpar_struct);
