classdef test_combine_sqw < TestCase
    ...
    methods
        function obj=test_combine_sqw(test_class_name)
            ...
            obj.par_file=fullfile(pths.test_common,'gen_sqw_96dets.nxspe');
        ...
        function test_combine1D(obj)
            ...
            %
            npix0 = obj.sqw_sample_gen.pix.num_pixels;
            ...
            n_pix = cut1.pix.num_pixels;

            assertEqual(npix0,n_pix)

            cut2 = copy(cut1);
            cut2.pix.signal = 2*cut2.pix.signal;
            comb_res = combine_sqw(cut1,cut2);
            npix2 = comb_res.pix.num_pixels;
        ...
        function test_combine1D_ortho(obj)
            ...
            npix0 = obj.sqw_sample_ortho.pix.num_pixels;
        ...
        function test_combine4D_ortho(obj)
            ...
            n_pix = obj.sqw_sample_ortho.pix.num_pixels;
