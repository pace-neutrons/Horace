classdef test_unique_objects < TestCase
    ...
    methods
        ...
        function test_change_serializer(obj)
            ...
            uoc = uoc.add(obj.mi1);
            uoc = uoc.add(mi2);
            voc = unique_objects_container('type','{}','convert_to_stream_f',@hlp_serialise);
            voc = voc.add(obj.mi1);
            voc = voc.add(mi2);
        ...
        function test_constructor_arguments_type_serializer(obj)
            ...
            uoc = unique_objects_container('type','{}','baseclass','IX_inst','convert_to_stream_f',@hlp_serialise);
        ...
        function test_subscripting_type_hlp_ser_wrong_subscript_plus(obj)
            ...
            uoc = unique_objects_container('type','{}','convert_to_stream_f',@hlp_serialise,'baseclass','IX_inst');
            function set_uoc()
                uoc{2} = obj.mi1;
            end
        ...
        function test_instr_replacement_with_duplicates(obj)
            uoc = unique_objects_container('type','{}','convert_to_stream_f',@hlp_serialise,'baseclass','IX_inst');
            uoc{1} = obj.mi1;
            uoc{2} = IX_null_inst();
