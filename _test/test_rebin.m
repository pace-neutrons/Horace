...
w2x_sim  =repmat(IX_dataset_2d,size(w2ref),numel(xint_arg));
w2x_mex  =repmat(IX_dataset_2d,size(w2ref),numel(xint_arg));
w2x      =repmat(IX_dataset_2d,size(w2ref),numel(xint_arg));
w2binx   =repmat(IX_dataset_2d,size(w2ref),numel(xint_arg));
w2y_sim  =repmat(IX_dataset_2d,size(w2ref),numel(yint_arg));
w2y_mex  =repmat(IX_dataset_2d,size(w2ref),numel(yint_arg));
w2y      =repmat(IX_dataset_2d,size(w2ref),numel(yint_arg));
w2biny   =repmat(IX_dataset_2d,size(w2ref),numel(yint_arg));
w2xy_sim =repmat(IX_dataset_2d,size(w2ref),numel(xyint_arg));
w2xy_mex =repmat(IX_dataset_2d,size(w2ref),numel(xyint_arg));
...
% ====================================================================================================================== 
% Save objects
output_file='c:\temp\test_rebin_output_new.mat';
