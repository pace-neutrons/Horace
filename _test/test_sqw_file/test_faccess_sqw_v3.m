classdef test_faccess_sqw_v3< TestCase
    ...
    methods
        ...
        function this=test_faccess_sqw_v3(varargin)
            ...
            this.sample_file = fullfile(this.sample_dir,'test_sqw_file_read_write_v3.sqw ');
...
%             assertTrue(ok);
%             assertEqual(to.file_version,'-v3');
%             
%             
%             
%         end
...
%             assertEqual(mheader.filename,'f1_1.sqw');
%             assertEqual(mheader.filepath,'C:\Users\tgp98\AppData\Local\Temp\');
%             
...
%             assertEqual(data_dnd.filename,'f1_1.sqw');
%             
...
%             assertEqual(sqw_obj1.main_header.filename,'f1_1.sqw')
%             assertEqual(sqw_obj1.main_header.filepath,...
%                 'C:\Users\tgp98\AppData\Local\Temp\')
%         end
        function obj = test_save_sqwV31(obj)
            samp_f = fullfile(fileparts(obj.sample_dir),...
            ...
            tf = fullfile(tempdir,'test_put_sqw_v3.sqw');
