classdef test_faccess_sqw_v4< TestCase
    ...
    methods
        ...
        function test_put_new_block_values_changes_data_in_file(obj)
            ...
            dnd_data.e(1)  = 0;
            dnd_data.npix(1)  = 0;
            ldr = ldr.put_new_blocks_values(dnd_data,'include', ...
                {'bl_data_metadata','bl_data_nd_data'});
        ...
        function test_wrong_input_throw(obj)
            ...
            ME1 = assertExceptionThrown(@()put_new_blocks_values(ldr, ...
                dnd_data,'exclude','pix_data','include','something_else'), ...
                'HORACE:file_io:invalid_argument');
            assertEqual(ME1.message,'"excluded" and "included" keywords can not be specified together');
