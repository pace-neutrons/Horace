classdef test_calc_qspec< TestCaseWithSave
    ...
    methods
        ...
        function test_calc_qspec_large_mode0(obj)
            ...
            te = toc(tb);
            assertEqualToTolWithSave(obj,qs,4e-15);
            assertEqualToTolWithSave(obj,en,4e-15);
        ...
        function test_calc_qspec_small_mode0(obj)
            ...
            emode = 0;
            [qs,en] = calc_qspec(dc, efix, eps, emode);
            assertEqualToTolWithSave(obj,qs,4.e-15);
            assertEqualToTolWithSave(obj,en,4.e-15);
        end
