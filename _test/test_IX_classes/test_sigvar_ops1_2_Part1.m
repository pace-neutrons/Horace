classdef test_sigvar_ops1_2_Part1 < TestCaseWithSave
    ...
    methods
        ...
        function test_sig_var_set_get_col(~)
            sv = sigvar();
            data = rand(2,10);

            sv.sig_var = data';
            assertEqual(sv.sig_var,data);
            assertEqual(sv.s,data(1,:))
            assertEqual(sv.e,data(2,:))
        end

        function test_sig_var_set_get_row(~)
            sv = sigvar();
            data = rand(2,10);
        ...
        %--------------------------------------------------------------------------
        function test_wscal_scal__flt_scal (~)
        ...
        %--------------------------------------------------------------------------
        function test_wscal_1by2__flt_scal (~)
        ...
        %--------------------------------------------------------------------------
        function test_wscal_1by2__flt_1by2 (~)
        ...
        %--------------------------------------------------------------------------
        function test_wscal_1by2__flt_2by2_FAIL (~)
        ...
        %--------------------------------------------------------------------------
        function test_w1by3_1by2__wscal_1by2 (~)
        ...
        %--------------------------------------------------------------------------
        function test_w1by3_mixed__w1by3_mixed (~)
        ...
        %--------------------------------------------------------------------------
        function test_w1by3_mixed__w1by2_mixed_FAIL (~)
        ...
        %--------------------------------------------------------------------------
        function test_w1by3_mixed__flt_scal (~)
        ...
        %--------------------------------------------------------------------------
        function test_w1by3_mixed__flt_1by3 (~)
        ...
        %--------------------------------------------------------------------------
        function test_w3by1_mixed__flt_3by1 (~)
            % Vector object, vector float same size as object array
            k11 = sigvar([31,5],[2,3]);
            k12 = sigvar([14;16],4);
            k13 = sigvar([22,18,14; 9,11,-0.5],[11,12,6; 0.4,0.8,1.4]);
        ...
        %--------------------------------------------------------------------------
        function test_w1by3_2by1__flt_2by3 (~)
        ...
        %--------------------------------------------------------------------------
        function test_w1by3_1by2__flt_2by3_FAIL (~)
            % Vector object, array float that can be resolved into stack
        ...
        %--------------------------------------------------------------------------
        function test_w1by3_mixed__flt_2by3_FAIL (~)
            % Vector object, array float that can be resolved into stack
