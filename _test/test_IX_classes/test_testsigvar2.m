classdef test_testsigvar2 < TestCaseWithSave
    % test_testsigvar2  Tests testsigvar2 objects
    %
    ...
    methods
        %--------------------------------------------------------------------------
        function self = test_testsigvar2 (name)
        ...
        function test_wscal_scal__wscal_scal (self)
            ...
            w1 = testsigvar2(3,25);
            w2= testsigvar2(4,144);
            wsum = testsigvar2(7,169);
        ...
        function test_wscal_1by2__wscal_1by2 (self)
            ...
            w1 = testsigvar2([31,5],[2,3]);
            w2 = testsigvar2([14,16],4);
            wsum = testsigvar2([45,21],[6,7]);
        ...
        function test_wscal_1by2__wscal_2by1_FAIL (self)
            ...
            w_1by2 = testsigvar2([31,5],[2,3]);
            w_2by1 = testsigvar2([14;16],4);
            
            testfun = @()plus(w_1by2,w_2by1);
            assertExceptionThrown(testfun, 'TESTSIGVAR2:binary_op_manager_single')
        ...
        function test_wscal_1by2__flt_scal (self)
            ...
            w = testsigvar2([31,5],[2,3]);
            f = 7;
            wsum = testsigvar2([38,12],[2,3]);
        ...
        function test_w1by3_1by2__wscal_1by2 (self)
            ...
            k1 = testsigvar2([31,5],[2,3]);
            k2 = testsigvar2([14,16],4);
            k3 = testsigvar2([22,18],[11,12]);
            k4 = testsigvar2([15,14],[2,3]);
        ...
        function test_w1by3_mixed__w1by3_mixed (self)
            ...
            k11 = testsigvar2([31,5],[2,3]);
            k12 = testsigvar2([14;16],4);
            k13 = testsigvar2([22,18,14; 9,11,-0.5],[11,12,6; 0.4,0.8,1.4]);
            
            k21 = testsigvar2([131,15],[2,3]);
            k22 = testsigvar2([24;26],3);
            k23 = testsigvar2([122,118,114; 29,211,-20.5],[311,312,36; 0.34,0.38,1.34]);
        ...
        function test_w1by3_mixed__w1by2_mixed_FAIL (self)
            ...
            testfun = @()plus(w1, w2);
            assertExceptionThrown(testfun, 'TESTSIGVAR2:binary_op_manager')
