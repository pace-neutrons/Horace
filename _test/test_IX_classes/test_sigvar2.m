classdef test_sigvar2 < TestCaseWithSave
    % test_sigvar2  Tests sigvar2 objects
    %
    ...
    methods
        %--------------------------------------------------------------------------
        function self = test_sigvar2 (name)
        ...
        function test_wscal_1by2__wscal_2by1_FAIL (self)
            ...
            w_1by2 = sigvar2([31,5],[2,3]);
            w_2by1 = sigvar2([14;16],4);
            
            testfun = @()plus(w_1by2,w_2by1);
            assertExceptionThrown(testfun, 'SIGVAR2:binary_op_manager_single')
        ...
        function test_w1by3_1by2__wscal_1by2 (self)
            ...
            k1 = sigvar2([31,5],[2,3]);
            k2 = sigvar2([14,16],4);
            k3 = sigvar2([22,18],[11,12]);
            k4 = sigvar2([15,14],[2,3]);
        ...
        function test_w1by3_mixed__w1by3_mixed (self)
            ...
            k11 = sigvar2([31,5],[2,3]);
            k12 = sigvar2([14;16],4);
            k13 = sigvar2([22,18,14; 9,11,-0.5],[11,12,6; 0.4,0.8,1.4]);
            
            k21 = sigvar2([131,15],[2,3]);
            k22 = sigvar2([24;26],3);
            k23 = sigvar2([122,118,114; 29,211,-20.5],[311,312,36; 0.34,0.38,1.34]);
        ...
        function test_w1by3_mixed__w1by2_mixed_FAIL (self)
            ...
            testfun = @()plus(w1, w2);
            assertExceptionThrown(testfun, 'SIGVAR2:binary_op_manager')
