classdef test_testsigvar_ops1_2_Part1 < TestCaseWithSave
    ...
    methods
        %--------------------------------------------------------------------------
        function self = test_testsigvar_ops1_2_Part1 (name)
        ...
        function test_wscal_1by2__flt_scal (self)
            ...
            w = testsigvar([31,5],[2,3]);
            f = 7;
            wsum = testsigvar([38,12],[2,3]);
        ...
        function test_w1by3_mixed__w1by3_mixed (self)
            ...
            k21 = testsigvar([131,15],[2,3]);
            k22 = testsigvar([24;26],3);
            k23 = testsigvar([122,118,114; 29,211,-20.5],[311,312,36; 0.34,0.38,1.34]);
