function instrument = let_instrument_obj_for_tests(ei, hz5, hz3, slot5_mm, mode, inst_ver)
% Return instrument description for LET
%
%   >> instrument = let_instrument_obj (ei, hz5, hz3, slot_mm, mode, inst_ver)
%
...
instrument = IX_inst_DGdisk (moderator, chop1, chop5,...
    horiz_div, vert_div, ei, 'LET', 'ISIS');
