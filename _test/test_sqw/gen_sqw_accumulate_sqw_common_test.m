classdef gen_sqw_accumulate_sqw_common_test < TestCaseWithSave
    ...
    properties
        ...
        % should not run due to the configuraton, the classes are tesing is not supported
        skip_test = false;
    ...
    methods
        ...
        function obj=test_accumulate_sqw14(obj,varargin)
            ...
            cleanup_obj1=onCleanup(@()obj.delete_files(sqw_file_14,sqw_file_accum));
            ...
            [dummy,dummy,urange14]=gen_sqw (obj.spe_file([1,4]), '', sqw_file_14, efix([1,4]), emode, alatt, angdeg, u, v, psi([1,4]), omega([1,4]), dpsi([1,4]), gl([1,4]), gs([1,4]));
        ...
        function obj=test_accumulate_sqw11456(obj,varargin)
            ...
            [dummy,dummy,urange]=gen_sqw (obj.spe_file([1,1,4,5,6]),...
