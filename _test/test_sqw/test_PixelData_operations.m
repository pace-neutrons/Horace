...
methods
    ...
    function test_compute_bin_data_correct_output_all_data_in_memory_mex_on(obj)
    ...
    function test_compute_bin_data_correct_output_file_backed_mex_on(obj)
        obj.config.use_mex = true;

        pix = PixelData(obj.test_sqw_file_path, 1e3);
        [s, e] = pix.compute_bin_data(obj.ref_npix_data);
