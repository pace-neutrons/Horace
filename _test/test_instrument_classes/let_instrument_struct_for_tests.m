function instrument = let_instrument_struct_for_tests(ei, hz5, hz3, slot5_mm, mode, inst_ver)
% Return instrument description for LET
%
%   >> instrument = let_instrument_struct_for_tests(ei, hz5, hz3, slot_mm, mode, inst_ver)
%
