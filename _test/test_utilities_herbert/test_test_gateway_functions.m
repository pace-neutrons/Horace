classdef test_test_gateway_functions < TestCaseWithSave
    ...
    methods
        %--------------------------------------------------------------------------
        function obj = test_test_gateway_functions (name)
            obj@TestCaseWithSave(name);
            
            % Make some test data
            T = testclass ('object_1',5);
            ...
            % [b1_f, b2_f] = testclass.function_3in_2out_accessor (a1, a2, a3);
            
            % Function in the /private folder in the class folder as a separate file
            % Use accessor method to reach it
            [b1_fp, b2_fp] = testclass.function_private_1in_2out_accessor (a1);
        ...
        function test_gateway_func_private_1 (obj)
            ...
            b1 = testclass.test_gateway ('function_private_1in_2out', obj.a1);
            assertEqual (b1, obj.b1_fp);
        end
        
        function test_gateway_func_private_2 (obj)
            % Test both outputs filled
            [b1, b2] = testclass.test_gateway ('function_private_1in_2out', obj.a1);
            assertEqual (b1, obj.b1_fp);
        ...
        function test_gateway_method_private_1 (obj)
            % Test first output only filled
            b1 = testclass.test_gateway ('method_private_1in_2out', obj.T, obj.a1);
            assertEqual (b1, obj.b1_mp);
        end
        
        function test_gateway_method_private_2 (obj)
            % Test both outputs filled
            [b1, b2] = testclass.test_gateway ('method_private_1in_2out', obj.T, obj.a1);
            assertEqual (b1, obj.b1_mp);
