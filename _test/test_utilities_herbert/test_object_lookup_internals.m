classdef test_object_lookup_internals < TestCaseWithSave
    ...
    methods
        ...
        %--------------------------------------------------------------------------
        function test_parse_eval_method_1 (~)
            % ind and randfunc only
            ind_in = [11,13,14];
            randfunc_in = @sin;
            [ind, ielmts, randfunc, args, split] = object_lookup.test_parse_eval_method ...
                (ind_in, randfunc_in);
        ...
        function test_parse_eval_method_2 (~)
            % ind, ielmts and randfunc
            ind_in = [11,13,14];
            ielmts_in = [5,16,3];
            randfunc_in = @sin;
            [ind, ielmts, randfunc, args, split] = object_lookup.test_parse_eval_method ...
                (ind_in, ielmts_in, randfunc_in);
            assertEqual (ind, ind_in);
        ...
        function test_parse_eval_method_3 (~)
            % ind, randfunc, p1; check that spots no ielmts given
            ind_in = [11,13,14];
            randfunc_in = @sin;
            p1_in = {5,true};
            [ind, ielmts, randfunc, args, split] = object_lookup.test_parse_eval_method ...
                (ind_in, randfunc_in, p1_in);
            assertEqual (ind, ind_in);
            assertEqual (ielmts, []);
            assertEqual (randfunc, randfunc_in);
        ...
        function test_parse_eval_method_4 (~)
            ...
            p2_in = rand(2,5,3);
            [ind, ielmts, randfunc, args, split] = object_lookup.test_parse_eval_method ...
                (ind_in, ielmts_in, 'split', randfunc_in, p1_in, p2_in);
            assertEqual (ind, ind_in);
            assertEqual (ielmts, ielmts_in);
            assertEqual (randfunc, randfunc_in);
        ...
        function test_parse_eval_method_5 (~)
            ...
            p3_in = rand(2,5,3);
            [ind, ielmts, randfunc, args, split] = object_lookup.test_parse_eval_method ...
                (ind_in, ielmts_in, 'split', iargs_in, randfunc_in, p1_in, p2_in, p3_in);
            assertEqual (ind, ind_in);
            assertEqual (ielmts, ielmts_in);
            assertEqual (randfunc, randfunc_in);
        ...
        function test_parse_eval_method_6 (~)
            ...
            p3_in = rand(2,5,3);
            [ind, ielmts, randfunc, args, split] = object_lookup.test_parse_eval_method ...
                (ind_in, 'split', iargs_in, randfunc_in, p1_in, p2_in, p3_in);
            assertEqual (ind, ind_in);
            assertEqual (ielmts, []);
            assertEqual (randfunc, randfunc_in);
            assertEqual (args, {p1_in, p2_in, p3_in});
        ...
        function test_parse_eval_method_err_1 (~)
            % No input arguments
        ...
        function test_parse_eval_method_err_2 (~)
        ...
        function test_parse_eval_method_err_3 (~)
        ...
        function test_parse_eval_method_err_4 (~)
            ...
            p3_in = rand(2,5,3);
            f = @()object_lookup.test_parse_eval_method ...
                (ind_in, ielmts_in, iargs_in, randfunc_in, p1_in, p2_in, p3_in);
            assertExceptionThrown (f, 'HERBERT:parse_split:invalid_argument');
        end
