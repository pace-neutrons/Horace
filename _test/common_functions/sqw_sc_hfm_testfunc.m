function weight = sqw_sc_hfm_testfunc (qh,qk,ql,en,par)
% Spectral weight for simple cubic n.n. Heisenberg ferromagnet
%
%   >> weight = sqw_sc_hfm_testfunc (qh,qk,ql,en,par)
%
% Input:
% ------
...
gamma=par(4);
bkconst=par(5);
weight = disp2sqw(qh,qk,ql,en,@disp_sc_hfm_testfunc,par(1:3),gamma) + bkconst;
