classdef test_multifit_horace_spinw< TestCaseWithSave
    ...
    properties
        ...
        win;
        sbcc;        % SpinW object
        sqw_bcc_spw; % Fit function wrapper
    end
    ...
    methods
        ...
        function this=test_fit_morethenone(this)
            ...
            % -------------------------------------------------------------------------------------------------
            if isempty(this.sqw_bcc_spw)
                return
            end
            % This will take a long time with your cross-section... first the evaluation of the initial conditions
            wsim_1=multifit_sqw_sqw(this.win, this.sqw_bcc_spw, [5,5,0,10,0], [1,1,0,0,0],...
                this.sqw_bcc_spw, {[5,5,1.2,10,0],[5,5,1.4,15,0]}, [1,1,1,1,1], {{{1,1,0},{2,2,0}}}, 'evaluate' );
            ...
            % and now the fit
            [wfit_1,fitpar_1]=multifit_sqw_sqw(this.win, this.sqw_bcc_spw, [5,5,0,10,0], [1,1,0,0,0],...
                this.sqw_bcc_spw, {[5,5,1.2,10,0],[5,5,1.4,15,0]}, [1,1,1,1,1], {{{1,1,0},{2,2,0}}});
        ...
        function this=test_fit_averg_hkl(this)
            ...
            % bins are in the cut.
            wsim_2=multifit_sqw_sqw(this.win, this.sqw_bcc_spw, [5,5,0,10,0], [1,1,0,0,0],...
                this.sqw_bcc_spw, {[5,5,1.2,10,0],[5,5,1.4,15,0]}, [1,1,1,1,1], {{{1,1,0},{2,2,0}}}, 'evaluate', 'ave' );
            
            [wfit_2,fitpar_2]=multifit_sqw_sqw(this.win, this.sqw_bcc_spw, [5,5,0,10,0], [1,1,0,0,0],...
                this.sqw_bcc_spw, {[5,5,1.2,10,0],[5,5,1.4,15,0]}, [1,1,1,1,1], {{{1,1,0},{2,2,0}}}, 'ave' );
            % Test against saved or store to save later
        ...
        function this=test_fit_single_or_array(this)
            ...
            [wfit_single1,fitpar_single1]=fit_sqw(this.w1data, this.sqw_bcc_spw, [5,5,1,10,0], [0,1,1,1,1], @linear_bkgd, [0,0]);
            
            [wfit_single2,fitpar_single2]=fit_sqw(this.w2data, this.sqw_bcc_spw, [5,5,1,10,0], [0,1,1,1,1], @linear_bkgd, [0,0]);
            [wfit_single12,fitpar_single12]=fit_sqw(this.win, this.sqw_bcc_spw, [5,5,1,10,0], [0,1,1,1,1], @linear_bkgd, [0,0]);
        ...
        function this=test_fit_single_or_array2(this)
            ...
            [wfit_single12,fitpar_single12]=fit_sqw(this.win, this.sqw_bcc_spw, [5,5,1,10,0.05], [0,1,1,1,1], @linear_bkgd, [0,0]);
            
            [wfit_single1,fitpar_single1]=multifit_sqw(this.w1data, this.sqw_bcc_spw, [5,5,1,10,0.05], [0,1,1,1,1], @linear_bkgd, [0,0]);
            [wfit_single2,fitpar_single2]=multifit_sqw(this.w2data, this.sqw_bcc_spw, [5,5,1,10,0.05], [0,1,1,1,1], @linear_bkgd, [0,0]);
        ...
        function this=test_multifit_single_or_array(this)
            ...
            [wfit_sqw_sqw,fitpar_sqw_sqw]=fit_sqw_sqw(this.win, this.sqw_bcc_spw, [5,5,1,10,0], [0,1,1,1,0], this.sqw_bcc_spw, [5,5,0,1,0], [0,0,0,0,1]);
            [tmp1,ftmp1]=multifit_sqw_sqw(this.w1data, this.sqw_bcc_spw, [5,5,1,10,0], [0,1,1,1,1]);
            [tmp2,ftmp2]=multifit_sqw_sqw(this.w2data, this.sqw_bcc_spw, [5,5,1,10,0], [0,1,1,1,1]);
