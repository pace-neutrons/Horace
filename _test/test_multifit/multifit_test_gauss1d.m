function [y1_fit, wstruct1_fit, w1_fit, p1_fit] = multifit_test_gauss1d (x1,y1,e1,wstruct1,w1,varargin)
...
% Perform fit
[y1_fit,py1_fit]=multifit(x1,y1,e1,varargin{:});
[wstruct1_fit,pwstruct1_fit]=multifit(wstruct1,varargin{:});
[w1_fit,pw1_fit]=multifit(w1,varargin{:});
