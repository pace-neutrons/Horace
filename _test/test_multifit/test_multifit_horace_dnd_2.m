classdef test_multifit_horace_dnd_2 < TestCaseWithSave
    ...
    methods
        function this=test_multifit_horace_dnd_2(name)
            % Construct object
            output_file = 'test_multifit_horace_2_dnd_output.mat';
            ...
            sqw_w1data = sqw(fullfile(data_dir,'w1data.sqw')); % was read_sqw
            sqw_w2data = sqw(fullfile(data_dir,'w2data.sqw')); % was read_sqw
        ...
        function this=test_fit(this)
            ...
            % For the equivalent sqw test (without _dnd in the name)
            % tol=[1e-10,1e-8] has worked. However this broader tolerance
            % is required for DnD
            tol = [1e-6,1e-6];
