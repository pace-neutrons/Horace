classdef test_sqw_op < TestCase 
    ...
    methods
        ...
        function obj = test_sqw_op(~)
            obj = obj@TestCase('test_sqw_op');
    ...
    methods (Static)
        function fake_dnd = build_fake_dnd()
            fake_dnd = d2d(line_axes('nbins_all_dims',[3,1,2,1]), ...
                line_proj('alatt',1,'angdeg',90));
