classdef test_mem_file_cut_and_filebased_construction < TestCase & common_sqw_file_state_holder
    ...
    methods
        ...
        function clearUp(obj)
            for i = 1:numel(obj.sqw1d_name)
                delete(obj.sqw1d_name{i});
            end
            for i = 1:numel(obj.sqw2d_name)
                delete(obj.sqw2d_name{i});
            end
            for i = 1:numel(obj.d1d_name)
                delete(obj.d1d_name{i});
            end
            for i = 1:numel(obj.d2d_name)
                delete(obj.d2d_name{i});
            end
        end
        ...
        % Perform tests
        %=============
        function obj = test_file_cut_array_vs_file_normal_buf(obj)
            skipTest()
        ...
        function obj = test_file_cut_array_vs_file_small_buf(obj)
            skipTest()
