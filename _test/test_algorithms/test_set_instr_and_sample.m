classdef test_set_instr_and_sample < TestCase
    ...
    methods
        ...
        function test_change_instr_sampl_in_file(obj)
            ...
            [ok,mess]=equal_to_tol(f1_1_s1_ref,tmp,[1.e-9,1.e-9], ...
            ...
            tmp=sqw(tmpsqwfile);
            [ok,mess]=equal_to_tol(f1_1_s2_ref,tmp,[1.e-9,1.e-9], ...
                '-ignore_date','ignore_str',1); 
            assertTrue(ok,mess)
            ...
            tmp=sqw(tmpsqwfile);
            [ok,mess]=equal_to_tol(f1_1_s3_ref,tmp,[1.e-9,1.e-9], ...
                '-ignore_date','ignore_str',1);
            assertTrue(ok,mess)
            ...
            tmp=sqw(tmpsqwfile);
            [ok,mess]=equal_to_tol(obj.ds.f1_1,tmp,[1.e-9,1.e-9], ...
                '-ignore_date','ignore_str',1); 
            assertTrue(ok,mess)
        end
