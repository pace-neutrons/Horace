classdef test_sqw_signal < TestCaseWithSave
    ...
    methods
        function obj = test_sqw_signal(varargin)
            ...
            %hp = horace_paths;
            test_common = fullfile(fileparts(fileparts(mfilename("fullpath"))),'test_sqw_file');
            test_sqw_1d_fullpath = fullfile(test_common,obj.sqw_file_1d_name);
            test_sqw_2d_fullpath = fullfile(test_common,obj.sqw_file_2d_name);
