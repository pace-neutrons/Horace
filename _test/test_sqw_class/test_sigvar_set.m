classdef test_sigvar_set < TestCase
    ...
    methods
        ...
        function test_sigvar_set_raises_error_if_s_not_same_size_as_dnd_object(~)
            sqw_obj = sqw();
            sqw_obj.data = d2d( ...
                axes_block('nbins_all_dims',[1,3,5,1],'img_range',[-1,-1,-1,-1;1,1,1,1]), ...
                ortho_proj());
        ...
        function test_sigvar_set_raises_error_if_e_not_same_size_as_dnd_object(~)
            sqw_obj = sqw();
            sqw_obj.data = d2d( ...
                axes_block('nbins_all_dims',[3,5,1,1],'img_range',[-1,-1,-1,-1;1,1,1,1]), ...
                ortho_proj());
        ...
        function test_sigvar_set_updates_s_and_e_values(~)
            sqw_obj = sqw();
            sqw_obj.data = d2d( ...
                axes_block('nbins_all_dims',[2,3,1,1],'img_range',[-1,-1,-1,-1;1,1,1,1]), ...
                ortho_proj());
        ...
        function test_sigvar_set_sets_pixel_data_as_npix_replica_of_image(~)
            sqw_obj = sqw();
            sqw_obj.data = d1d( ...
                axes_block('nbins_all_dims',[1,3,1,1],'img_range',[-1,-1,-1,-1;1,1,1,1]), ...
                ortho_proj());
