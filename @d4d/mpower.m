function w = mpower (w1, w2)
% Implement w1 ^ w2 for 4D datasets
%
%   >> w = w1 ^ w2
%
...
%         combined element by element with the 2D dataset, and the outer (n-4) must
%         match the array size of the 4D dataset array

w = dnd_binary_op(w1,w2,@single_mpower,'d4d',4);