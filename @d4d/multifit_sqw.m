...
% Simultaneously fit function(s) of S(Q,w)to one or more d4d objects
%
...
% For details <a href="matlab:help('mfclass_Horace_sqw');">Click here</a>
%
...
%   be <a href="matlab:help('d4d/multifit_legacy_sqw');">found here</a>]
...
if ~mfclass.legacy(varargin{:})
    ...
    varargout = mfclass.legacy_call (@multifit_legacy_sqw, nargout, varargin{:});
end
