...
% Read header of a d4d object stored in a file
% 
%   >> w=head(d4d,file)
%
% Need to give first argument as a d4d object to enforce the execution of this method.
% Can simply create a dummy object with a call to sqw:
%    e.g. >> read(d4d,'c:\temp\my_file.sqw')
