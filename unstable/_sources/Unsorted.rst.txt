Unsorted Manual Pages
#####################

These are pages from the wiki which have not been sorted into a category
and may not be needed in the new documentation.
...
.. toctree::
   ...
   manual/Fitting
   manual/Herbert
   manual/Horace_and_Libisis_installation
   ...
   manual/Script_for_generating_sqw_files
   manual/Script_for_making_cuts_and_plotting
