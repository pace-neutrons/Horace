function [grid_size,urange] = calc_and_write_sqw(sqw_file,grid_size_in,urange_in, ...
...
if ~use_mex    
    ...
    %====
    %RAE modification for test purposes, whilst mex files not working:
    sqw_data.p=p;
    %End of RAE modification
    %====
