function [istart,iend,irange,inside,outside] = get_irange_rot(urange,rot,trans,varargin)
...
if ndim==3
    ...
    [istart,iend,inside,outside] = get_irange3D_rot(urange,rot,trans,varargin{1:3});
    irange=zeros(2,0);
else
    ...
    [istart,iend,inside3D,outside3D] = get_irange3D_rot(urange,rot,trans,varargin{1:3});
    if ~outside3D
...
%========================================================================================
function [istart,iend,inside,outside] = get_irange3D_rot(urange,rot,trans,p1,p2,p3)
