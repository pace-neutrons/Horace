...
for i=1:nfiles
        ...
        [grid_size_tmp,urange1,det0] = write_spe_to_sqw (spe_data{i}, par_file, tmp_file{i}, efix(i), emode, alatt, angdeg,...
            u, v, psi(i), omega(i), dpsi(i), gl(i), gs(i), grid_size_in, urange,det0);
        if i==1
