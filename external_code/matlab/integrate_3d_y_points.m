function [sout,eout] = integrate_3d_y_points (x, s, e, xout)
% Integrate point data along axis iax=2 of an IX_dataset_nd with dimensionality ndim=3.
...
while ib<=nb
    ...
    [sout(:,ib,:),eout(:,ib,:)] = single_integrate_3d_y_points(x,s,e,iax,xout(ib),xout(ib+1),ml,mu,sz_wrk);
...
%======================================================================================================================
function [val, errbar] = single_integrate_3d_y_points (x, s, e, iax, xmin, xmax, ml, mu, sz_wrk)
