function [sout,eout] = integrate_3d_x_points (x, s, e, xout)
% Integrate point data along axis iax=1 of an IX_dataset_nd with dimensionality ndim=3.
...
%======================================================================================================================
function [val, errbar] = single_integrate_3d_x_points (x, s, e, iax, xmin, xmax, ml, mu, sz_wrk)
