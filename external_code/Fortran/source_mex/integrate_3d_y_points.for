#include "fintrf.h"
!===========================================================================================================
! Integrate y-axis over a 3D data set with point character along the y-axis, for
! intervals in a set of bin boundaries.
!
!   >> [sout, eout] = integrate_3d_y_points (y, s, e, yout)
!
! Input:
! ---------
...
! Perform rebinning:
      call IFL_integrate_3d_y_points (ierr,
