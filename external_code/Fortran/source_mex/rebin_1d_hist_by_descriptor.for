...
!
!   >> [xout, yout, eout] = rebin_1d_hist_by_desriptor (x, y, e, xbounds)
!
! Input:
! ---------
...
! Internal declations
      mwPointer x_pr, y_pr, e_pr, xbounds_pr
      mwPointer xout_pr, yout_pr, eout_pr
      mwSize nx, nb, mx
...
! Check for proper number of MATLAB input and output arguments 
     ...
     +    ('Four inputs (x, y, e, xout) required.')
      ...
      if (nlhs .ne. 3) then
          call mexErrMsgTxt('Three outputs (xout,yout,eout) required.')
      endif
