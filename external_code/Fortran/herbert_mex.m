...
%   >> herbert_mex(source_code)     % Specific mex function e.g. >> herbert_mex ('rebin_1d_hist') (assumed .for)
...
%----------------------------------------------------------------
function create_mex_files (root_dir, mex_dir, lib_dir, flname, debug)
