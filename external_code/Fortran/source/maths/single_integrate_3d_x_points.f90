...
!-----------------------------------------------------------------------------------------------------------------------------------
! Integrate x-axis over a 3D data set with point character along the x-axis between two limits.
...
!-----------------------------------------------------------------------------------------------------------------------------------
	...
	real(dp) x1eff, xneff
	real(dp), dimension(size(s,2),size(s,3)) :: s1eff, sneff, e1eff, eneff
