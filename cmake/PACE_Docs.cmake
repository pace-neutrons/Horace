...
if (sphinx-build)
  if (UNIX)
    ...
    add_custom_target(denullify-docs
      COMMAND powershell -command "Foreach($f in Get-ChildItem -Path '${DOCS_DIR}/build/html' -Filter *.html) {(Get-Content $f.FullName) | Where-Object {$_ -notmatch '\[NULL\]'} | Set-Content $F.FullName}"
      DEPENDS build-docs
      VERBATIM
      )
  endif()
